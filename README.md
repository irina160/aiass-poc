...
> Hinweis: Um mit der Git Bash dieses Repo "klonen" zu können, müsst ihr dort einmal `git config --global http.sslBackend schannel` ausführen.
...
> 2. Type in Tasks: Run Tasks and hit ENTER
...
1. ideally: create another env with azd init {env_name} for local development
1. IMPORTANT: When developing locally add QUART_ENV="development" to your .azure > {env} > .env file
1. Retrieve User Object ID via: portal.azure.com > Azure AD > Users > {select your user} > in the overview there is the field Object ID
1. Talk to Yannik Suhre and provide the Object ID. He has to run the last step on his machine.
